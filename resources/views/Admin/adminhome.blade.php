...
<body>
    ...
    <div class="row" style="background-color:#f54266; height: 80px; padding-top: 20px;text-align:right;">
        <div class="col-lg-6" >
                ...
                <div class="row" style="background-image: linear-gradient(white,#0384fc);height:100%;">
                    <div class="col-lg-12">
                        <div class="nav flex-column nav-pills" id="tab" role="tablist" aria-orientation="vertical" style="padding:50px;">
                            ...
                            <a class="nav-link"  href="add" role="tab">Add Department</a>
                            <a class="nav-link"  href="changeuser" role="tab">Change Username</a>
                            <a class="nav-link"  href="changepass" role="tab">Change Password</a>
